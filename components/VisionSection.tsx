...
export default function VisionSection() {
  return (
    <section className="relative lg:h-screen py-4 lg:py-12 bg-[#050505]">
      {/* Mobile Banner */}
          ...
          <div className="absolute inset-0 z-10 flex items-start">
            <div className="w-full px-4 pt-4">
              <motion.div
                ...
                className="max-w-xl"
              >
                <h3 className="text-[#FF5A00] font-semibold mb-2 uppercase tracking-wider text-xs">About Spacor Sports</h3>
                <h2 className="text-lg md:text-xl font-bold text-[#FFFFFF] mb-2 leading-tight">
                  WE DON'T JUST MANAGE SPORTS.
                </h2>
                <h2 className="text-lg md:text-xl font-bold text-[#FF5A00] mb-3 leading-tight">
                  WE TRANSFORM LIVES.
                </h2>
                <p className="text-[#E7E7E7] text-xs leading-relaxed mb-2">
